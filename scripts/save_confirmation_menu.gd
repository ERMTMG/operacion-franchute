...
const SAVE_CONFIRMATION_MENU_SOUNDS: Dictionary[StringName, AudioStream] = {
...
func play_window_close_sound() -> void:
	Global.GAME_MANAGER.play_sfx(SAVE_CONFIRMATION_MENU_SOUNDS[&"WINDOW_CLOSE"])
...
func _on_save_button_pressed() -> void:
	Global.GAME_MANAGER.play_sfx(SAVE_CONFIRMATION_MENU_SOUNDS[&"BUTTON_PRESS"])
...
func _on_visibility_changed() -> void:
	if visible and Global.GAME_MANAGER != null:
		Global.GAME_MANAGER.play_sfx(SAVE_CONFIRMATION_MENU_SOUNDS[&"WINDOW_POPUP"])
